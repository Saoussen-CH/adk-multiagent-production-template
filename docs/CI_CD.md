...
> 2. Link the repository: **Link Repository** → select `YOUR_GITHUB_USERNAME/YOUR_REPO_NAME`
...
repositoryEventConfig:
  push:
    branch: "^main$"
  repository: projects/YOUR_PROJECT_ID/locations/us-central1/connections/github-connection/repositories/YOUR_GITHUB_USERNAME-YOUR_REPO_NAME
